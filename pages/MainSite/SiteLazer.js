const SiteLazer = () => {
    return ( 
        <div>
            ✔️✔️✔️ Lazer fire success <br /> ✔️TFTPGM Loaded. 
            <br /> 
            ✔️All Systems Operational. <br /> 
            ✔️Heart status: 💚💚💚<br /> 
            ✔️Resonance levels are stable☀️ <br /> 
            All clear to proceed. <br /> 
            ✔️✔️✔️✔️✔️✔️<br /> <br /> 
            ...
            <br /> 
            Following the TFTPGM will help the Future Traveler survive on a journey 
            as the FT navigates closer to their heart and all is made known.  

        </div>
     );
}
 
export default SiteLazer;